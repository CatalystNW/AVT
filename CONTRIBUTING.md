...
```
sudo bash -E -c "export AVT_GIT_BRANCH=aws-config && export AVT_AUTO_S3=catalyst-db-dev/env_files/.env-test && $(wget -O - https://raw.githubusercontent.com/dandahle/Catalyst-AppVetting/${AVT_GIT_BRANCH}/script/init-curl.sh)"
```
