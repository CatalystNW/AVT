...
```
export AVT_GIT_BRANCH=aws-config && sudo AVT_AUTO_S3=catalyst-db-dev/env_files/.env-test AVT_GIT_BRANCH=${AVT_GIT_BRANCH} bash -c "$(wget -O - https://raw.githubusercontent.com/dandahle/Catalyst-AppVetting/${AVT_GIT_BRANCH}/script/init-curl.sh)"
```
